...
* 
*/
class EscsoftwareModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("esc_softwares")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("esc_softwares")->row();
