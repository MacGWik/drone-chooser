...
<body>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default" style="margin-top: 10%;">
                    <div class="panel-heading">
                        <h3 class="panel-title">Silahkan Daftar User</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Nama" name="name" id="name" type="text" autofocus>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Konfirmasi Password" name="password" id="passwordConfirm" type="password" value="">
                                </div>
                                <!-- Change this to a button or input when using this as a form -->
                                <input type="button" class="btn btn-lg btn-success btn-block" value="Daftar" id="btnLogin">
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        $("#btnLogin").click(function(){
            ...
            var passwordInputConfirm = $('#passwordConfirm').val();

            if(nameInput == "" || emailInput == "" || passwordInput == "" || passwordInputConfirm == ""){
                $.displayError("Harap Masukkan Data Secara Benar !");
            }else if(passwordInput != passwordInputConfirm){
                $.displayError('Password dan Konfirmasi Password Tidak Sama !');
            }else{
                $.post("<?php echo site_url('user/register/ajaxrequest'); ?>",
                { 
                    name:nameInput,
                    email:emailInput,
