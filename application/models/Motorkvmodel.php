...
* 
*/
class MotorkvModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("motor_kvs")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("motor_kvs")->row();
