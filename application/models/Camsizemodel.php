...
* 
*/
class CamsizeModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("cam_sizes")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("cam_sizes")->row();
