...
* 
*/
class PropsizeModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("prop_sizes")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("prop_sizes")->row();
