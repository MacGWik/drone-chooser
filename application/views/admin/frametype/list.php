...
<script>
	...
	function CreatedataTbl(){ //alert(jmlhari);
		...
		dataTbl = $('#dataTbl').dataTable({
	        ...
	        "bProcessing": true,
	        "bServerSide": true,
	        "sAjaxSource": site_url+'datasource/frametype',
	        "aoColumnDefs": [
		        {
	...
	function resetCallBack()
	{
		$(".btnDelete").click(function(e){
			...
			$.displayConfirm("Are you sure to delete this data?",function(){
				// $(".loading").show();
				$.post("<?php echo site_url('admin/frametype/delete'); ?>",
				{ 
					id:data 
				},
					function(data){
