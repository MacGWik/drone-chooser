...
* 
*/
class FcsoftwareModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("fc_softwares")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("fc_softwares")->row();
