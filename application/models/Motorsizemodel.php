...
* 
*/
class MotorsizeModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("motor_sizes")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("motor_sizes")->row();
