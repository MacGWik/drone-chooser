...
* 
*/
class BatterysizeModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("battery_sizes")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("battery_sizes")->row();
