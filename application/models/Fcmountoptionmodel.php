...
* 
*/
class FcmountoptionModel extends CI_Model
{
	...
	function GetAllData(){
		...
		$data = $this->db->get("fc_mount_options")->result_array();
	...
	function GetLatestDataByTipe($tipe_id){
		...
		$data = $this->db->get("fc_mount_options")->row();
	...
	function Insert($data){
		...
		$this->db->insert("fc_mount_options");
	...
	function Update($data){
		...
		$this->db->update("fc_mount_options");
	}
