...
<script>
	...
	function CreatedataTbl(){ //alert(jmlhari);
		...
		dataTbl = $('#dataTbl').dataTable({
	        ...
	        "bProcessing": true,
	        "bServerSide": true,
	        "sAjaxSource": site_url+'datasource/proppitch',
	        "aoColumnDefs": [
		        {
	...
	function resetCallBack()
	{
		$(".btnDelete").click(function(e){
			...
			$.displayConfirm("Are you sure to delete this data?",function(){
				// $(".loading").show();
				$.post("<?php echo site_url('admin/proppitch/delete'); ?>",
				{ 
					id:data 
				},
					function(data){
