...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2019 at 11:49 PM
...
(6, 8, 13, 4, 3, 3, 2, 1, 1, 'Build #6', 1, '{"frame":"Frame ALPHASQUAD Seeker ditujukan untuk Racing dengan posisi baterai di Atas Frame namun bukan tipe frame Pure X","fc":"Sistem memilih FC KISS V2 FC karena memiliki Software KISS dan kompatibel dengan frame ALPHASQUAD Seeker","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Micro Arrow Pro karena kompatibel dengan frame ALPHASQUAD Seeker","motor":"Sistem memilih motor AMAXInno 2306 2500kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame ALPHASQUAD Seeker","esc":"Sistem memilih ESC KISS 32A ESC karena dapat menerima aliran arus sebesar 45A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-13 16:48:43', '2019-08-15 07:11:07'),
(7, 2, 5, 4, 5, 3, 2, 1, 1, NULL, 1, '{"frame":"Frame TruX-R ditujukan untuk Racing dengan tipe frame Pure X dan posisi baterai di Bawah Frame","fc":"Sistem memilih FC KISS V2 FC karena memiliki Software KISS dan kompatibel dengan frame TruX-R","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Runcam Swift V3 karena kompatibel dengan frame TruX-R","motor":"Sistem memilih motor Emax Eco 2306-2400kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame TruX-R","esc":"Sistem memilih ESC KISS 32A ESC karena dapat menerima aliran arus sebesar 45A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-15 07:38:21', '2019-08-15 07:38:21'),
(8, 2, 13, 4, 1, 3, 2, 1, 1, 'Build #8', 1, '{"frame":"Frame TruX-R ditujukan untuk Racing dengan tipe frame Pure X dan posisi baterai di Bawah Frame","fc":"Sistem memilih FC KISS V2 FC karena memiliki Software KISS dan kompatibel dengan frame TruX-R","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Arrow V3 karena kompatibel dengan frame TruX-R","motor":"Sistem memilih motor AMAXInno 2306 2500kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame TruX-R","esc":"Sistem memilih ESC KISS 32A ESC karena dapat menerima aliran arus sebesar 45A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-15 07:39:58', '2019-08-15 07:39:58'),
(11, 8, 6, 4, 3, 6, 3, 2, 1, 'Build #11', 1, '{"frame":"Frame ALPHASQUAD Seeker ditujukan untuk Racing dengan tipe frame Stretched X dan posisi baterai di Atas Frame","fc":"Sistem memilih FC Skitzo Revolt V2 karena memiliki Software FlightOne dan kompatibel dengan frame ALPHASQUAD Seeker","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Micro Arrow Pro karena kompatibel dengan frame ALPHASQUAD Seeker","motor":"Sistem memilih motor Emax RSII 2306 1800kv karena memiliki RPM Tinggi pada saat menggunakan baterai 6S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame ALPHASQUAD Seeker","esc":"Sistem memilih ESC Raceflight Bolt32 50A Skitzo karena dapat menerima aliran arus sebesar 50A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-15 07:56:24', '2019-08-15 07:56:24'),
(12, 5, 9, 6, 1, 6, 3, 1, 1, 'Build #12', 1, '{"frame":"Frame ACROBOT Zenith SX V-Arm ditujukan untuk Racing dengan tipe frame Pure X dan posisi baterai di Bawah Frame","fc":"Sistem memilih FC Skitzo Revolt V2 karena memiliki Software FlightOne dan kompatibel dengan frame ACROBOT Zenith SX V-Arm","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Arrow V3 karena kompatibel dengan frame ACROBOT Zenith SX V-Arm","motor":"Sistem memilih motor iFlight Force IF2207 2700kv karena memiliki RPM Tinggi pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 45 dan dapat digunakan pada frame ACROBOT Zenith SX V-Arm","esc":"Sistem memilih ESC Raceflight Bolt32 50A Skitzo karena dapat menerima aliran arus sebesar 50A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-15 08:05:51', '2019-08-15 08:05:51'),
(13, 8, 13, 6, 3, 6, 3, 1, 1, 'Build #13', 2, '{"frame":"Frame ALPHASQUAD Seeker ditujukan untuk Racing dengan posisi baterai di Atas Frame namun bukan tipe frame Pure X","fc":"Sistem memilih FC Skitzo Revolt V2 karena memiliki Software FlightOne dan kompatibel dengan frame ALPHASQUAD Seeker","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Micro Arrow Pro karena kompatibel dengan frame ALPHASQUAD Seeker","motor":"Sistem memilih motor AMAXInno 2306 2500kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 45 dan dapat digunakan pada frame ALPHASQUAD Seeker","esc":"Sistem memilih ESC Raceflight Bolt32 50A Skitzo karena dapat menerima aliran arus sebesar 50A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-17 06:00:30', '2019-08-17 06:00:30'),
(14, 8, 13, 4, 3, 6, 4, 1, 1, 'Build #14', 1, '{"frame":"Frame ALPHASQUAD Seeker ditujukan untuk Racing dengan posisi baterai di Atas Frame namun bukan tipe frame Pure X","fc":"Sistem memilih FC Skitzo Revolt V2 karena memiliki Software FlightOne dan kompatibel dengan frame ALPHASQUAD Seeker","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Micro Arrow Pro karena kompatibel dengan frame ALPHASQUAD Seeker","motor":"Sistem memilih motor AMAXInno 2306 2500kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame ALPHASQUAD Seeker","esc":"Sistem memilih ESC AfterBurner 4 In 1 ESC 50A karena dapat menerima aliran arus sebesar 50A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-20 13:18:27', '2019-08-20 13:18:27'),
(15, 8, 13, 4, 3, 6, 4, 1, 1, 'Build #15', 1, '{"frame":"Frame ALPHASQUAD Seeker ditujukan untuk Racing dengan posisi baterai di Atas Frame namun bukan tipe frame Pure X","fc":"Sistem memilih FC Skitzo Revolt V2 karena memiliki Software FlightOne dan kompatibel dengan frame ALPHASQUAD Seeker","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Micro Arrow Pro karena kompatibel dengan frame ALPHASQUAD Seeker","motor":"Sistem memilih motor AMAXInno 2306 2500kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame ALPHASQUAD Seeker","esc":"Sistem memilih ESC AfterBurner 4 In 1 ESC 50A karena dapat menerima aliran arus sebesar 50A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-20 13:45:17', '2019-08-20 13:45:18'),
(16, 8, 5, 4, 3, 6, 3, 1, 1, 'Build #16', 1, '{"frame":"Frame ALPHASQUAD Seeker ditujukan untuk Racing dengan posisi baterai di Atas Frame namun bukan tipe frame Pure X","fc":"Sistem memilih FC Skitzo Revolt V2 karena memiliki Software FlightOne dan kompatibel dengan frame ALPHASQUAD Seeker","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Micro Arrow Pro karena kompatibel dengan frame ALPHASQUAD Seeker","motor":"Sistem memilih motor Emax Eco 2306-2400kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame ALPHASQUAD Seeker","esc":"Sistem memilih ESC Raceflight Bolt32 50A Skitzo karena dapat menerima aliran arus sebesar 50A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-20 13:45:28', '2019-08-20 13:45:28'),
(17, 8, 5, 4, 3, 3, 2, 1, 1, 'Build #17', NULL, '{"frame":"Frame ALPHASQUAD Seeker ditujukan untuk Racing dengan tipe frame Stretched X dan posisi baterai di Atas Frame","fc":"Sistem memilih FC KISS V2 FC karena memiliki Software KISS dan kompatibel dengan frame ALPHASQUAD Seeker","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Micro Arrow Pro karena kompatibel dengan frame ALPHASQUAD Seeker","motor":"Sistem memilih motor Emax Eco 2306-2400kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame ALPHASQUAD Seeker","esc":"Sistem memilih ESC KISS 32A ESC karena dapat menerima aliran arus sebesar 45A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-20 13:50:02', '2019-08-20 13:50:02'),
(18, 2, 13, 4, 1, 1, 2, 1, 1, 'Build #18', NULL, '{"frame":"Frame TruX-R ditujukan untuk Racing dengan tipe frame Pure X dan posisi baterai di Bawah Frame","fc":"Sistem memilih FC KISS V1 karena memiliki Software KISS dan kompatibel dengan frame TruX-R","vtx":"Sistem memilih VTX TBS Unify Race karena memiliki power output 25mW yang umum digunakan untuk Racing","fpv_cam":"Sistem memilih FPV Camera Foxeer Arrow V3 karena kompatibel dengan frame TruX-R","motor":"Sistem memilih motor AMAXInno 2306 2500kv karena memiliki RPM Rendah pada saat menggunakan baterai 4S","prop":"Sistem berhasil menemukan prop dengan pitch 40 dan dapat digunakan pada frame TruX-R","esc":"Sistem memilih ESC KISS 32A ESC karena dapat menerima aliran arus sebesar 45A yang diperkirakan akan ditarik oleh kombinasi motor dan prop yang akan digunakan"}', '2019-08-20 14:21:37', '2019-08-20 14:21:37');
...
(1, 1, 1, 'Ethix S3', '2019-08-17 07:45:13', '2019-07-30 06:28:24', '2019-07-30 06:28:24'),
...
(2, '6', '2019-08-17 07:42:20', '2019-07-28 23:01:55', '2019-07-28 23:01:55'),
...
(2, 'Mindy Atikah Chiara G', 'arguspolim@yahoo.com', 'fca9340b3ae1325ea9077b3a72874cb1', NULL, '2019-08-17 05:35:59', '2019-08-17 05:35:59'),
(3, 'mindy', 'mindy@gmail.com', '1a1dc91c907325c69271ddf0c944bc72', NULL, '2019-08-20 13:52:01', '2019-08-20 13:52:01'),
(4, 'tes', 'tes@gmail.com', '1a1dc91c907325c69271ddf0c944bc72', NULL, '2019-08-20 14:13:29', '2019-08-20 14:13:29');
...
INSERT INTO `user_builds` (`id`, `user_id`, `build_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
(20, 1, 6, NULL, '2019-08-16 07:53:43', '2019-08-16 07:53:43'),
(21, 2, 13, NULL, '2019-08-17 07:05:06', '2019-08-17 07:05:06'),
(22, 1, 13, NULL, '2019-08-17 07:05:16', '2019-08-17 07:05:16'),
(23, 1, 14, NULL, '2019-08-20 13:18:27', '2019-08-20 13:18:27'),
(24, 1, 15, NULL, '2019-08-20 13:45:18', '2019-08-20 13:45:18'),
(25, 1, 16, NULL, '2019-08-20 13:45:28', '2019-08-20 13:45:28');

-- --------------------------------------------------------

--
-- Stand-in structure for view `user_builds_builds_users`
--
CREATE TABLE IF NOT EXISTS `user_builds_builds_users` (
`id` int(10)
...
--
-- Structure for view `user_builds_builds_users`
--
DROP TABLE IF EXISTS `user_builds_builds_users`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_builds_builds_users` AS select `a`.`id` AS `id`,`a`.`user_id` AS `user_id`,`a`.`build_id` AS `build_id`,`a`.`deleted_at` AS `deleted_at`,`a`.`created_at` AS `created_at`,`a`.`updated_at` AS `updated_at`,`b`.`name` AS `build_name`,`c`.`name` AS `user_name` from ((`user_builds` `a` left join `builds` `b` on((`a`.`build_id` = `b`.`id`))) left join `users` `c` on((`b`.`user_owner_id` = `c`.`id`)));
