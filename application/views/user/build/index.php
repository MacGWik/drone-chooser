		<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-7" style="padding-right: 0px;">
                    <h1 class="page-header">Daftar Rakitan Tersimpan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<script>
	...
	function CreatedataTbl(){ //alert(jmlhari);
		...
		var tr = $('<table id="dataTbl" class="order-column hover"></table>')
			.append($("<thead></thead>")
			.append($("<tr></tr>")
			.append($("<th ></th>").append("No"))
			.append($("<th ></th>").append("Nama Rakitan"))
			.append($("<th ></th>").append("Pemilik"))
		...
		dataTbl = $('#dataTbl').dataTable({
	        ...
	        "bProcessing": true,
	        "bServerSide": true,
	        "sAjaxSource": site_url+'datasource/userbuild',
	        "aoColumnDefs": [
		        {
