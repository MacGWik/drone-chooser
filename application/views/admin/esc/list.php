...
<script>
	...
	function CreatedataTbl(){ //alert(jmlhari);
		...
		var tr = $('<table id="dataTbl" class="order-column hover"></table>')
			...
			.append($("<th ></th>").append("Ampere Rating"))
			.append($("<th ></th>").append("ESC Software"))
			.append($("<th ></th>").append("Lowest Battery Rating"))
			.append($("<th ></th>").append("Highest Battery Rating"))
		...
		dataTbl = $('#dataTbl').dataTable({
	        ...
	        "bProcessing": true,
	        "bServerSide": true,
	        "sAjaxSource": site_url+'datasource/esc',
	        "aoColumnDefs": [
		        {
	...
	function resetCallBack()
	{
		$(".btnDelete").click(function(e){
			...
			$.displayConfirm("Are you sure to delete this data?",function(){
				// $(".loading").show();
				$.post("<?php echo site_url('admin/esc/delete'); ?>",
				{ 
					id:data 
				},
					function(data){
